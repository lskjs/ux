...
class TreePicker extends Component {
  ...
  @bind handleReset(simple) {
    this.resetToProps();
    if (!simple) this.modal.close();
  }
  @bind async handleSubmit() {
  ...
  render() {
    ...
    const { title, flat, fields, createTag, children, t, clearBtnStyles } = this.props;
