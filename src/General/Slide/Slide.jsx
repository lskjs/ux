...
export default class Slide extends Component {
  ...
  renderBg() {
    ...
    const { overlay, video, image } = this.props;
    if (overlay) {
    ...
    return (<div styleName="Slide__bg">
      ...
      <If condition={this.props.overlay}>
        <div styleName="Slide__overlay" style={{ backgroundColor: color }} />
      </If>
      <If condition={video}>
  ...
  renderInner() {
    ...
    const { width, top, left, right, bottom, content, children } = this.props;
    const style = {};
  ...
  render() {
    const { style, color, className, fixed, center } = this.props;
