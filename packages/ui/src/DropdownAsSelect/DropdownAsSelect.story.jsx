...
export default ({ storiesOf }) => {
  storiesOf('ui/DropdownAsSelect', module)
    .add('Default', () => (
      <Story>
        <DropdownAsSelect id="demo" trigger={<FilterValue>Значение</FilterValue>}>
          Content
        </DropdownAsSelect>
      </Story>
    ))
    .add('withRangeFilterOption', () => (
      <Story>
        <DropdownAsSelect
          ...
          trigger={<FilterValue>Значение</FilterValue>}
        >
          {/* <RangeFilterOption
            value={[10000, 20000]}
            onChange={e => {
            ...
            min={10000}
            max={2000000}
            stats={[3, 45, 2, 15, 80, 50, 20, 10, 15, 15, 31, 12, 50, 88, 68, 48]}
            quickValues={{
              min: [
                {
                  value: 10000,
