...
export default ({ storiesOf }) =>
  storiesOf('progress/Progress', module)
    .add('default', () => (
      <Story>
        <Wrapper>
          <Progress />
...
{global ? 'true' : 'false'}
              ...
              <button onClick={() => setState({ value: 0 })}>value = 0</button>
              <button onClick={() => setState({ value: value + 5 })}>value ++</button>
              <Progress value={value} speed={5} isLoading global={global} height={7} />
            </div>
          </Wrapper>
        )}
      </Story>
