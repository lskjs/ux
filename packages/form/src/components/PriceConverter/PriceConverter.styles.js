...
import CurrencyInput from '../BaseInput';
...
export const Input = styled(CurrencyInput)`
  font-family: ${p => getTheme(p.theme, 'fontFamily')} !important;
...
export const Action = styled('button')`
  ...
  background-color: ${props => (
    props.active
      ...
      : getTheme(props.theme, 'colors.white')
  )};
  flex: 1;
  padding: 6px 8px;
  outline: none;
  ...
  text-align: left;
  color: ${p => (p.active ? getTheme(p.theme, 'colors.white') : getTheme(p.theme, 'colors.main'))};
